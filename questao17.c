...
int main()
{
    ...
    for (int i = 0; i < QTD_NUMS; i++)
    {
        ...
        if (numero > maiorNumero)
            ...
            menorNumero = numero; // Ataliza o valor do menor número
    }

    // Calcula a diferença do maior valor pelo menor.
    int dif = maiorNumero - menorNumero;

    // Imprimindo os valores das variáveis
    printf("Menor número: %d\n", menorNumero);
    printf("Maior número: %d\n", maiorNumero);
    printf("Diferença do maior valor pelo menor: %d\n", dif);
